...
std::string NanoID::generate()
{
	return generate(impl::random, impl::default_dict, impl::default_size);
}
std::string NanoID::generate(const std::string& alphabet)
{
	return generate(impl::random, alphabet, impl::default_size);
}
std::string NanoID::generate(std::size_t size)
{
	return generate(impl::random, impl::default_dict, size);
}
std::string NanoID::generate(const std::string& alphabet, std::size_t size)
{
	return generate(impl::random, alphabet, size);
}

std::future<std::string> NanoID::generate_async()
{
	return std::async
	( 
...
std::future<std::string> NanoID::generate_async(const std::string& alphabet)
{
	return std::async
	(
		(impl::gen_func_type)(generate),
...
std::future<std::string> NanoID::generate_async(std::size_t size)
{
	return std::async
	(
		(impl::gen_func_type)(generate),
...
std::future<std::string> NanoID::generate_async(const std::string& alphabet, std::size_t size)
{
	return std::async
	(
		(impl::gen_func_type)(generate),
...
std::string NanoID::generate(crypto_random_base& random)
{
	return generate(random, impl::default_dict, impl::default_size);
}
std::string NanoID::generate(crypto_random_base& random, const std::string& alphabet)
{
	return generate(random, alphabet, impl::default_size);
}
std::string NanoID::generate(crypto_random_base& random, std::size_t size)
{
	return generate(random, impl::default_dict, size);
}
std::string NanoID::generate(crypto_random_base& random, const std::string& alphabet, std::size_t size)
{
